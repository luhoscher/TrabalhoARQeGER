...
//import br.udesc.argc.gui.view.TabelaNoticias;
//import br.udesc.argc.gui.view.tables.NovasTabelas;
//import br.udesc.argc.persistence.dao.core.FactoryDAO;
//import br.udesc.modulo1.persistence.dao.core.NewsDAO;
 ...
 * @author gabrielnaoto
 */
public class NoticiasControle {

    private TabelaNoticias wn;
    private NovasTabelas nm;
    //private NewsDAO dao;

    public NoticiasControle() {
        wn = new TabelaNoticias();
        nm = new NovasTabelas();
